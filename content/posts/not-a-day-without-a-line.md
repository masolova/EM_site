...
![](/assets/posts/not-a-day-without-a-line-1-forza-cover.jpg)
...
Может ли полный новичок кодить с ИИ? Да, но а). потребуется время на выработку эффективной модели работы, б). логичному технарю будет сильно проще, чем гуманитарию (будет сильно мешать «изысканный жираф»), в). желательно снизить свои требования (хотя бы временно).
...
Конечно, первое приложение было самым простым. Я его сделаю частью (одной из вкладок) большого приложения LLL (Lena Learns Latvian) и обновлю дизайн. Старую версию можно посмотреть [здесь на Гитхабе](https://masolova.github.io/LLL/).
